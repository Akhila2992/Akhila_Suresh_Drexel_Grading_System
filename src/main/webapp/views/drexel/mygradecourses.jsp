<%@page import="com.dgs.data.domain.Studentmapping"%>
        ...
        <%@page import="com.dgs.infra.constants.DGSCommonConstants"%>
          <%@page import="com.dgs.web.constants.DGSWebConstants"%>
            ...
            <%@page import="java.util.List" %>
              ...
              List<Studentmapping> gradeCourseList = (List<Studentmapping>) restUtil.getData(DGSWebConstants.DGS.GET_MY_GRADE_COURSE_DETAILS+"?userId="+userId,DGSList.class);
              pageContext.setAttribute("gradeCourseList",gradeCourseList);
       ...
       <table class="main_table" cellpadding="0" cellspacing="0">
        ...
        <table align="center">
         <tr>
                    ...
                    <tr>
                    <c:forEach var="gradeCourseList" items="${gradeCourseList}">
                    <tr>
                    <td >
                    ${gradeCourseList.coursemaster.courseId}        
                    </td>
                    <td >
                    ${gradeCourseList.coursemaster.courseName}        
                    </td>
                    <td >
                    ${gradeCourseList.grademaster.gradeId}        
                    </td>
                    </tr>
                    </c:forEach>
                    </tr>
